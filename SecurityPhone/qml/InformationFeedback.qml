...
Page {
        ...
        MouseArea {
            ...
            onReleased: {
                ...
                if( Math.abs(xDiff) > Math.abs(yDiff) ) {
                    if( oldX < mouseX) {
                        if(informationFeedback.status == PageStatus.Active){
    ...
    Column {
        ...
        Text {
            ...
            text: "The app gives you feedback\nwhen entering the password.\n   The device beeps when\n   entering the correnct\n   password and buzzes\n          if we entered\n   the right combination."
            color: "red"
            font.bold: true
        }
    }

    Text {  font.pointSize: 40; text: "feedBack"; anchors.bottom: parent.bottom; anchors.bottomMargin: 40; anchors.horizontalCenterOffset: 0; font.bold: true; verticalAlignment: Text.AlignTop; horizontalAlignment: Text.AlignHCenter; anchors.horizontalCenter: parent.horizontalCenter; font.family: iFont.name; color:"#bbb"}
